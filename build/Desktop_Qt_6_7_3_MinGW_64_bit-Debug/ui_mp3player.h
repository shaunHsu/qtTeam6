...
public:
    ...
    void setupUi(QMainWindow *mp3Player)
    {
        ...
        gridLayoutWidget->setGeometry(QRect(110, 490, 631, 80));
        ...
        horizontalLayoutWidget->setGeometry(QRect(530, 440, 211, 51));
        ...
        tabWidget->setGeometry(QRect(90, 0, 701, 411));
        Tab1 = new QWidget();
        ...
        TrackDuration->setGeometry(QRect(419, 440, 91, 20));
        TrackTitle = new QLabel(centralwidget);
        TrackTitle->setObjectName("TrackTitle");
        TrackTitle->setGeometry(QRect(90, 420, 331, 20));
